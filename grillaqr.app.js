            ...
            const handleDeleteRow = (rowId) => {
                setModalState({
                    ...
                    onConfirm: async () => {
                        ...
                        setIsSaving(true);
                        const { error } = await supabaseClient.rpc('delete_pallet_lot', { p_nropallet: rowId });
                        setIsSaving(false);
                        if (error) {
                ...
                return (
                    <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50 p-4">
                        <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-sm">
                            ...
                            {type !== 'confirm' && (
                                <input ref={inputRef} type={type === 'password' ? 'password' : 'text'} value={inputValue} onChange={e => setInputValue(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleConfirm()} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 border" autoComplete="off" />
                            )}
                            <div className="flex justify-end space-x-3 mt-6">
                                <button onClick={onClose} className="bg-gray-200 text-gray-800 font-semibold py-2 px-4 rounded-lg hover:bg-gray-300">Cancelar</button>
            ...
            return (
                <div className="min-h-screen p-4 sm:p-6 bg-black bg-opacity-50">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-xl">
                        ...
                        <div class="flex justify-between items-center mb-4 p-4 border rounded-lg bg-gray-50">
                            <div class="flex items-center space-x-4">
                                ...
                                <div className="flex items-center space-x-2 pl-4">
                                    ...
                                    />
                                    <label htmlFor="autoRefresh" className="text-sm font-medium text-gray-700">Refrescar automáticamente</label>
                                </div>
                            </div>
                        ...
                        <div className="overflow-auto rounded-lg shadow-md border" style={{ height: '60vh', minHeight: '60vh', resize: 'vertical' }}>
